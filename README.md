...
- Retrieval modu:
  - `RETRIEVAL_MODE=hybrid` (varsayilan, mevcut FTS+RAG akisi)
  - `RETRIEVAL_MODE=long_context` (tum makaleleri buyuk context olarak modele verir)
  - Long-context ince ayar: `LONG_CONTEXT_ARTICLE_LIMIT`, `LONG_CONTEXT_SUPPORT_ARTICLES`, `LONG_CONTEXT_PER_ARTICLE_CHARS`, `LONG_CONTEXT_MAX_CHARS`
